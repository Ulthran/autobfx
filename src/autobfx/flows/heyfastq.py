...
def heyfastq_flow(project_fp: Path, config: Config, samples: dict[str, Path] = {}) -> list[Path]:
...
if __name__ == "__main__":
    ...
    heyfastq_flow(project_fp=Path(args.project_fp).absolute(), config=config, samples=samples)